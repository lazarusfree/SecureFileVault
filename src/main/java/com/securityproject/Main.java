...
public class Main {
    public static void main(String[] args) {
        ...
        /*try { //phase3
            ...
            System.out.println("Password valid? " + SecurityUtils.checkPassword(originalPw, hashed));
            //3. test encrypttion
        ...
        */
        ...
        boolean registered = DatabaseManager.registeruser("rezza", "superDuperUltraSecretPassword");
        if (registered) {
            System.out.println(" -> Successfully registered user 'rezza'");
        } else {
            System.out.println(" -> Failed to registered user 'rezza'. User already exists.");
        }

        //login (fail case)
        System.out.println("\n[2] Attempting login with WRONG password...");
        int userID = DatabaseManager.authenticateUser("rezza", "superDuperUltraSecretWrongPassword");
        if (userID == -1) {
        ...
        userID = DatabaseManager.authenticateUser("rezza", "superDuperUltraSecretPassword");
